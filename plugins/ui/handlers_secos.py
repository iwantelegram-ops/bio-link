...
async def cb_secos_setmon(client: Client, cb: CallbackQuery):
    ...
    await safe_edit(
        ...
        f"<b>3️⃣ Tambahkan Bot Pemantau sebagai Member Grup</b>\n"
        f"   Bot sudah bekerja, Boleh tambahkan bot pemantau sebagai <b>admin</b>\n"
        f"   di grup agar lebih optimal (opsional)."
        f"{ub_admin_text}\n\n"
